...
public class Estudiante {
    ...
    if (this.promedio > 85) {
        return "¡Felicidades! El estudiante " + this.nombres + " " + this.apellidos + " ha sido otorgado una beca.";
    } else {
        return "Lo sentimos, el estudiante " + this.nombres + " " + this.apellidos + " no cumple con los requisitos para obtener una beca.";
    }
}
}
